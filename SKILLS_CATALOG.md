...
> 自动生成于 2026-08-03 11:33:41，由 github-manager 维护
> GitHub 账号：xjxlx
...
| [code-image](https://github.com/xjxlx/skills/tree/main/code-image) | Use when 蓝湖下载的图片文件名不符合 Android 资源命名规范、需要按指定 Compose 文件生成资源名、需要处理 mipmap 路径冲突，... | 无 | 已发布 | - |
