...
> 自动生成于 2026-08-07 00:08:50，由 github-manager 维护
> GitHub 账号：xjxlx
...
| [code-image](https://github.com/xjxlx/skills/tree/main/code-image) | Use when 需要将单个 Android mipmap 图片改为合规资源名，并记录原始名称与新名称的稳定映射。 | 无 | 已发布 | 2026-08-06 |
...
- **目录名**：`code-image`
- **用途**：Use when 需要将单个 Android mipmap 图片改为合规资源名，并记录原始名称与新名称的稳定映射。
- **依赖**：无
- **文件数**：6
- **UI 元数据**：有 agents/openai.yaml
